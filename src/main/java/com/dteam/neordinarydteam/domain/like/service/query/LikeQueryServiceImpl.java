...
public class LikeQueryServiceImpl implements LikeQueryService {
    ...
    public PageResponse<LikeResponse.MyDTO> getMyLikes(UUID uuid, Pageable pageable) {
        ...
        //                .orElseThrow(() -> new CustomerException(CustomerErrorCode.CUSTOMER_NOT_FOUND));
        //
        //        Page<Like> likes = likeRepository.findByCustomerId(customer.getId(), pageable);
        //        List<Facility> facilities = facilityRepository.findAllByIdIn();
        //
        //        return PageConverter.toPageResponse()
        return null;
    }
}
